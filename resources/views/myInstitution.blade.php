<!-- resources/views/myInstitution.blade.php -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <script>
        function navigateToForm() {
            window.location.href = '{{ url('/update_form') }}';
        }
    </script>
</head>
<body>
    ...
    <div class="container mx-auto mt-10">
        <div class="card mx-auto text-center" style="max-width: 800px;">
            <h2 class="text-2xl font-bold mb-4">Mon Institution</h2>
            <div class="forum-buttons">
                <div class="forum-button" onclick="navigateToForm()">Insérer / Mettre à jour mes données</div>
                <div class="forum-button">Télécharger la fiche</div>
            </div>
        </div>
    </div>
</body>
